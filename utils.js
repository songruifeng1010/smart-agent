...
function getFallbackResponse() {
  const responses = [
    ...
    '抱歉啊，我现在还回答不了这个问题...你想让我帮你算点什么吗？',
    '让我想想...你可以试试问我一些简单的问题，比如计算或者单位转换？',
    '这个问题挺有意思的！不过我现在还不太清楚...你想听个笑话吗？',
    '嗯，这个问题我暂时不太了解。我们聊聊别的吧？',
    '抱歉，我现在还回答不了这个问题。你有其他想聊的吗？',
    '这个我不太确定，我们换个话题怎么样？'
  ];
